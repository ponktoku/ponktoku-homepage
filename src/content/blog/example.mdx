---
title: 'example'
description: 'Example mdx file for testing'
pubDate: 2024-01-20
author: 'John Doe'
cover: 'image1.png'
tags: ['tech', 'hardware', 'mdx']
category: 'tech'
slug: example
---
...
I need to make a component that can I import to mdx files to add spacing between code blocks when I want 2 code blocks one after the other.

```js title="src/my-test-file.js"
